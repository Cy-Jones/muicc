      ...
      <div className="mx-auto max-w-[96%] px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-3 shrink-0 w-full justify-center md:w-auto md:flex-1 md:justify-start">
          ...
          <div className="flex flex-col">
            <span className="font-heading text-lg font-black text-gold tracking-widest leading-none">MULSU ICC <span className="text-dark-bg">'26</span></span>
            <span className="text-[9px] text-dark-muted uppercase tracking-[0.2em] mt-0.5 font-bold">Champions Cup</span>
          </div>
        </div>

        {/* Middle: Links */}
        <div className="flex flex-row flex-nowrap justify-center items-center gap-3 sm:gap-6 text-[9px] sm:text-[11px] font-bold text-dark-bg uppercase tracking-widest w-full md:w-auto mt-4 md:mt-0">
        ...
        <div className="flex items-center gap-4 shrink-0 w-full justify-center md:w-auto md:flex-1 md:justify-end">
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="text-dark-bg hover:text-gold transition-colors"
