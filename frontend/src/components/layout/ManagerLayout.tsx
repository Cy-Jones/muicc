...
import { removeManagerToken } from '../../lib/api';
      ...
      <header className="w-full bg-surface-card border-b border-surface-border shadow-sm flex items-center justify-between px-4 sm:px-8 h-16 sm:h-20 shrink-0 z-50">
        <Link to="/admin" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-dark-muted font-bold uppercase tracking-widest leading-none mt-1">Team Manager Portal</span>
          </div>
        </Link>
        <button 
