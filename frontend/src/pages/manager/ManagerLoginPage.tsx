...
import { api, setManagerToken } from '../../lib/api';
import { Lock, Message, Danger, ShieldDone, Show, Hide } from 'react-iconly';
...
export const ManagerLoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage(err.message || 'Invalid manager email or password.');
    } finally {
      setLoading(false);
    }
  };
        ...
        >
          <div className="text-center space-y-3 mb-10">
            ...
            <div className="space-y-2">
              <h1 className="font-heading text-3xl sm:text-4xl font-black text-dark-bg uppercase tracking-tight">Manager Portal</h1>
              <p className="text-sm text-dark-surface font-medium">Restricted access for official national team managers.</p>
            </div>
          </div>
